...
use Inventa\DespesasBundle\Entity\Categories;
use Inventa\DespesasBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('InventaDespesasBundle:Categories')->findAll();

        return $this->render('InventaDespesasBundle:Categories:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('InventaDespesasBundle:Categories:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('InventaDespesasBundle:Categories')->find($id);
        ...
        return $this->render('InventaDespesasBundle:Categories:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('InventaDespesasBundle:Categories:edit.html.twig', array(
            'entity'      => $entity,
